...
const Aparadores = () => {
    ...
    return (
        <div className="bg-white">
            ...
            <p class="text-center mx-6 sm:mx-auto text-xl leading-8 text-[#9b2323] max-w-5xl">Renove sua sala com os aparadores da Sandiz Móveis. <br /> Escolha entre uma variedade de estilos disponíveis para entrega imediata ou encomenda.</p>
