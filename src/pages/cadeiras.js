...
const Cadeiras = () => {
    ...
    return (
        <div className="bg-white">
            ...
            <NavBar />
            <h2 class="sm:mt-36 text-center text-4xl font-bold tracking-tight text-[#a72626] sm:text-6xl">CADEIRAS</h2>
            <div className='mt-4 border-t-2 border-[#a72626] max-w-80 mx-auto pt-6'></div>
            <p class="text-center mx-auto text-xl leading-8 text-[#9b2323] max-w-5xl">Renove sua sala com as cadeiras da Sandiz Móveis. <br /> Escolha entre uma variedade de estilos disponíveis para entrega imediata ou encomenda.</p>
