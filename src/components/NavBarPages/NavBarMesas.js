        ...
        <header className='absolute inset-x-0 top-0 z-50 bg-[#eb3334]' id='inicio'>
            <nav className='flex items-center justify-between p-6 lg:px-8' aria-label='Global'>
                ...
                <div className='text-base hidden lg:flex lg:gap-x-6'>
                    {/*<a href='' className='font-semibold leading-6 text-white'>APARADORES</a>*/}
                    ...
                    <div className='mt-6 flow-root'>
                        <div className='-my-6 divide-y divide-gray-500/25'>
                            <div className='space-y-8 py-10 ml-4'>
                               {/* <a href='' className='block text-lg font-semibold leading-6 text-white'><button onClick={() => setIsSidebarOpen(false)}>APARADORES</button></a>*/}
