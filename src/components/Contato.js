...
const Contato = () => {
    return (
        <div>
            <h1 class="mt-20 text-center text-2xl font-bold tracking-tight text-gray-900 sm:text-4xl">ENTRE EM CONTATO</h1>
            <div className='mt-10 flex flex-col md:flex-row'>
                <div className='isolate px-6 mb-20 lg:px-20'>
                    <ul className='space-y-6 mb-5'>
                        <li>
                            <div className='flex gap-x-4 mx-8'>
                                ...
                                <dd className='text-xl text-gray-900' to='#' >+55 47 3385-0127</dd>
                            </div>
                        </li>
                        <li>
                            <div className='flex gap-x-4 mx-8'>
                                ...
                                <Link to={getWhatsUrl(CTA_WHATSAPP_MENSAGENS.ctaButton)} target='_blank'>
                                    <dd className='text-xl text-gray-900' >+55 47 99215-7200</dd>
                                </Link>
                            </div>
                        </li>
                        <li>
                            <div className='flex gap-x-4 mx-8'>
                                ...
                                <Link to={URLS.instagram} target='_blank'>
                                    <dd className='text-xl text-gray-900' >@sandiz_moveis</dd>
                                </Link>
                            </div>
                        </li>
                        <li>
                            <div className='flex gap-x-4 mx-8'>
                                <dt className='flex-none'>
                                    ...
                                    <Link to='https://maps.app.goo.gl/TyZXexCdy5FzSrjT8'>
                                        <svg className='h-7 w-6 text-gray-900' fill='none' viewBox='0 0 24 24' stroke-width='1.5' stroke='currentColor' aria-hidden='true'>
                                            <path stroke-linecap='round' stroke-linejoin='round' d='M2.25 21h19.5m-18-18v18m10.5-18v18m6-13.5V21M6.75 6.75h.75m-.75 3h.75m-.75 3h.75m3-6h.75m-.75 3h.75m-.75 3h.75M6.75 21v-3.375c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21M3 3h12m-.75 4.5H21m-3.75 3.75h.008v.008h-.008v-.008zm0 3h.008v.008h-.008v-.008zm0 3h.008v.008h-.008v-.008z' />
                                        </svg>
                                    </Link>
                                </dt>
                                <Link to='https://maps.app.goo.gl/TyZXexCdy5FzSrjT8'>
                                    <dd className='text-xl text-gray-900'>Rua Indaial, 440 - Quintino - Timbó - SC</dd>
                                </Link>
                            </div>
                        </li>
                    </ul>
