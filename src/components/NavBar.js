    ...
    return (
        <header className='absolute inset-x-0 top-0 z-50 bg-[#eb3334]' id='inicio'>
            <nav className='flex items-center justify-between p-6 lg:px-8' aria-label='Global'>
                ...
                <div className='hidden lg:mr-10 lg:flex lg:gap-x-8'>
                    <a href='#' className='text-base font-semibold leading-6 text-white'>BANQUETAS</a>
                    <a href='#' className='text-base font-semibold leading-6 text-white'>CADEIRAS</a>
                    <a href='#' className='text-base font-semibold leading-6 text-white'>ESTOFADOS</a>
