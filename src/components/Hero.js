                ...
                <img src={Loja} alt='imagem loja' className='absolute inset-0 -z-10 h-full w-full object-cover' />
                    <div className='text-center mx-auto max-w-3xl py-22 sm:py-32'>
                        ...
                        <div className='mt-10 flex items-center justify-center gap-x-6'>
                            <a href='#' className='rounded-xl bg-[#eb3334] px-10 py-3 text-lg font-bold text-white shadow-sm hover:bg-[#db5454] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#db5454]'>ENTRAR EM CONTATO <span aria-hidden='true'>&rarr;</span></a>
                        </div>
                </div>
            </div>
        </div>
